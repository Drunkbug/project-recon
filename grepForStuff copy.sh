...
#egrep -io "bjmt........" httpdata.txt | sort | uniq -c
egrep -io "bjm????????" httpdata.txt | sort | uniq -c
egrep -io "bjm?????????" httpdata.txt | sort | uniq -c
...
grep -i "358363063603237" httpdata.txt | sort | uniq -c
grep -i "355031040753366" httpdata.txt | sort | uniq -c
grep -i "359213072264548" httpdata.txt | sort | uniq -c
grep -i "frisk6230" httpdata.txt | sort| uniq -c

#contact info (phone specific)
#grep -i "[strings in your contacts list]" httpdata.txt | sort | uniq -c
grep -iE "8572726567|857-272-6567|2022030131|202-203-0131" httpdata.txt | sort | uniq -c
